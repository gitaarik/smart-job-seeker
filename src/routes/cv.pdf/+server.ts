...
export const GET: RequestHandler = async ({ url }) => {
  ...
  const cvFilename = "Rik Wanders - Senior Full Stack Developer - CV.pdf";

  // Construct file path based on profile type
  ...
  if (!(filePath in fileImports)) {
    ...
    throw error(
      404,
      "CV file not found. Please contact the administrator.",
    );
  }
