...
import { rejectJob, saveJob, unrejectJob, unsaveJob } from '$lib/server/job/job-actions';
import {
	buildJsonFilters,
	buildScoreFilter,
	JOB_LIST_PAGE_SIZE,
...
async function countMatchingJobs(profileId: number, url: URL): Promise<number> {
