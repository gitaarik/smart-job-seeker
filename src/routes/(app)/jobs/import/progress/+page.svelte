  ...
  {:else}
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6 mt-4">
      ...
      <div class="bg-[var(--dash-card)] border border-[var(--dash-border)] rounded-lg p-4">
        ...
        {#if matchedCount > 0}
          <div class="flex flex-wrap items-center gap-2 mt-2">
            <a href="/jobs?minScore=1" class="inline-flex whitespace-nowrap text-xs px-2 py-0.5 rounded border border-[var(--dash-border)] text-[var(--dash-primary)] hover:bg-[var(--dash-bg)] transition-colors">View</a>
            <button
      ...
      <div class="bg-[var(--dash-card)] border border-[var(--dash-border)] rounded-lg p-4">
        ...
        {#if noMatchCount > 0}
          <div class="flex flex-wrap items-center gap-2 mt-2">
            <a href="/jobs?minScore=0" class="inline-flex whitespace-nowrap text-xs px-2 py-0.5 rounded border border-[var(--dash-border)] text-[var(--dash-primary)] hover:bg-[var(--dash-bg)] transition-colors">View</a>
            <button
      ...
      <div class="bg-[var(--dash-card)] border border-[var(--dash-border)] rounded-lg p-4">
        ...
        {#if unmatchedCount > 0}
          <a href="/jobs?minScore=unmatched" class="mt-2 inline-flex whitespace-nowrap text-xs px-2 py-0.5 rounded border border-[var(--dash-border)] text-[var(--dash-primary)] hover:bg-[var(--dash-bg)] transition-colors">View</a>
        {/if}
      </div>
      ...
      <div class="bg-[var(--dash-card)] border border-[var(--dash-border)] rounded-lg p-4">
        ...
        <a href="/jobs" class="mt-2 inline-flex whitespace-nowrap text-xs px-2 py-0.5 rounded border border-[var(--dash-border)] text-[var(--dash-primary)] hover:bg-[var(--dash-bg)] transition-colors">View</a>
      </div>
    </div>
