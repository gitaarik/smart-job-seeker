...
<div class="space-y-2">
  <div>
    ...
    <input
      ...
      disabled={saving}
      class="w-full px-2 py-1.5 text-sm border border-[var(--dash-border)] rounded bg-[var(--dash-bg)] text-[var(--dash-text)] disabled:opacity-60"
    />
  ...
  {#if dirty}
    <div class="flex justify-end gap-2">
      <button
        ...
        onclick={cancel}
        disabled={saving}
        class="inline-flex items-center gap-1.5 px-3 py-1 text-xs border border-[var(--dash-border)] rounded text-[var(--dash-text)] hover:bg-[var(--dash-bg)] disabled:opacity-50"
      >
      ...
      <button
        ...
        onclick={save}
        disabled={saving}
        class="inline-flex items-center gap-1.5 px-3 py-1 text-xs bg-[var(--dash-primary)] text-white rounded hover:bg-[var(--dash-primary-hover)] disabled:opacity-50"
      >
        {#if saving}
