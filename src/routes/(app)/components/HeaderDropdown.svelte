...
<div class="relative">
	...
	{#if isOpen}
		<div
			class="fixed right-2 left-2 sm:absolute sm:!top-auto sm:right-0 sm:left-auto sm:mt-2 sm:w-max sm:min-{width} z-50 overflow-hidden rounded-lg border border-[var(--dash-border)] bg-[var(--dash-card)] shadow-lg sm:max-w-sm"
