<script lang="ts">
	...
	function handleUploadComplete(data: { parsedData: unknown; fileId: string; fileName: string }) {
...
<div class="space-y-6">
	<SectionHeader
		title={showReview && reviewSource !== 'manual' ? 'Review Your Profile' : 'Create Your Profile'}
		icon={faUser}
	/>
