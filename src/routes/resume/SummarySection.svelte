...
<ResumeSection title="Summary" icon={faCompass} class="leading-relaxed">
  ...
  <p>
    I'm currently looking for exciting and challenging remote projects (6-12
    months), or longer term part-time roles, where I can apply my expertise and
    creativity. I thrive in dynamic agile teams or startup environments that
