    ...
    >
      {#if localBrowserAllowed}
        <button
          ...
          {disabled}
          onclick={() => select(null)}
          class="px-3 py-1.5 text-xs flex items-center gap-1.5 transition-colors disabled:opacity-60 {value === null ? 'bg-[var(--dash-primary)] text-white' : 'bg-[var(--dash-bg)] text-[var(--dash-text)] hover:bg-[var(--dash-bg-hover)]'}"
        >
      ...
      <button
        ...
        class="px-3 py-1.5 text-xs flex items-center gap-1.5 {localBrowserAllowed ? 'border-l border-[var(--dash-border)]' : ''} transition-colors disabled:opacity-60 {value === 'hosted' ? 'bg-[var(--dash-primary)] text-white' : 'bg-[var(--dash-bg)] text-[var(--dash-text)] hover:bg-[var(--dash-bg-hover)]'}"
      >
      ...
      <button
        ...
        class="px-3 py-1.5 text-xs flex items-center gap-1.5 border-l border-[var(--dash-border)] transition-colors disabled:opacity-60 {value === 'local' ? 'bg-[var(--dash-primary)] text-white' : 'bg-[var(--dash-bg)] text-[var(--dash-text)] hover:bg-[var(--dash-bg-hover)]'}"
      >
