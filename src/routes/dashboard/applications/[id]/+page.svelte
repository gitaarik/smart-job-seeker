...
<div class="space-y-6">
  ...
  <!-- Status -->
  <div class="space-y-3 sm:bg-[var(--dash-card)] sm:rounded-lg sm:border sm:border-[var(--dash-border)] sm:p-6">
  ...
  <!-- Texts / Documents / Salary -->
  <div class="hidden sm:grid sm:grid-cols-3 gap-6">
    <div class="space-y-3 bg-[var(--dash-card)] rounded-lg border border-[var(--dash-border)] p-6">
      <div class="flex items-center gap-2">
        <FontAwesomeIcon icon={faEnvelope} class="w-4 h-4 text-[var(--dash-text-secondary)]" />
        <h2 class="text-sm font-semibold text-[var(--dash-text)] uppercase tracking-wide">Texts</h2>
      </div>
      <div class="space-y-2">
        <div class="flex items-center justify-between text-sm">
          ...
          <span class="text-[var(--dash-text)] font-medium">
            ...
            {#if letterCount > readyLetterCount}
              <span class="text-[var(--dash-text-muted)]">/ {letterCount} total</span>
            {/if}
          </span>
        </div>
        <div class="flex items-center justify-between text-sm">
          ...
          <span class="text-[var(--dash-text)] font-medium">
            ...
            {#if questionCount > answeredQuestionCount}
              <span class="text-[var(--dash-text-muted)]">/ {questionCount} total</span>
            {/if}
          </span>
        </div>
      </div>
      <a href="/dashboard/applications/{app.id}/letters" class="flex items-center gap-1.5 text-xs text-[var(--dash-primary)] hover:underline pt-1">
    ...
    <div class="space-y-3 bg-[var(--dash-card)] rounded-lg border border-[var(--dash-border)] p-6">
      <div class="flex items-center gap-2">
        <FontAwesomeIcon icon={faFileAlt} class="w-4 h-4 text-[var(--dash-text-secondary)]" />
        <h2 class="text-sm font-semibold text-[var(--dash-text)] uppercase tracking-wide">Documents</h2>
      </div>
      <div class="space-y-2">
        <div class="flex items-center justify-between text-sm">
          <span class="text-[var(--dash-text-secondary)]">Files</span>
          <span class="text-[var(--dash-text)] font-medium">{fileCount} attached</span>
        </div>
        <div class="flex items-center justify-between text-sm">
          <span class="text-[var(--dash-text-secondary)]">CV Sent</span>
          <span class="text-[var(--dash-text)] font-medium truncate ml-2">{app.directus_files?.filename_download || "None"}</span>
        </div>
      </div>
      <a href="/dashboard/applications/{app.id}/documents" class="flex items-center gap-1.5 text-xs text-[var(--dash-primary)] hover:underline pt-1">
    ...
    <div class="space-y-3 bg-[var(--dash-card)] rounded-lg border border-[var(--dash-border)] p-6">
      <div class="flex items-center gap-2">
        <FontAwesomeIcon icon={faMoneyBillWave} class="w-4 h-4 text-[var(--dash-text-secondary)]" />
        <h2 class="text-sm font-semibold text-[var(--dash-text)] uppercase tracking-wide">Salary</h2>
      </div>
      <div class="space-y-2">
        <div class="flex items-center justify-between text-sm">
          <span class="text-[var(--dash-text-secondary)]">Expectation</span>
          <span class="text-[var(--dash-text)] font-medium">{formatCurrency(app.salary_expectation, app.salary_currency, app.salary_period)}</span>
        </div>
        {#if job?.salary_min || job?.salary_max}
          <div class="flex items-center justify-between text-sm">
            ...
            <span class="text-[var(--dash-text)] font-medium">{formatSalaryRange(job.salary_min, job.salary_max, job.salary_currency, job.salary_period)}</span>
          </div>
        {/if}
      </div>
      <a href="/dashboard/applications/{app.id}/salary" class="flex items-center gap-1.5 text-xs text-[var(--dash-primary)] hover:underline pt-1">
