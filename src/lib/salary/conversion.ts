...
export function estimateIncome(
	...
	const freelanceNetYear = Math.round(freelanceGrossYear * (1 - freelancePct / 100));
 ...
 */
export function projectToHourly(totalAmount: number, durationWeeks: number): number {
