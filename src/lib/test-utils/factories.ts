 ...
 */
export function createMockAiChatPrompt(
 ...
 */
export function createMockProfileWithRelations(
 ...
 */
export function createMockCollectedData(
  overrides: Record<string, any> = {},
): any {
  return {
    id: 1,
 ...
 */
export function createMockJobVacancy(
  overrides: Partial<any> = {},
): any {
  return {
    id: 1,
