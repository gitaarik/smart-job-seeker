 ...
 */
export function recordsEqual<T extends Record<string, unknown>>(a: T, b: T): boolean {
 ...
 */
export function diffPayload<T extends Record<string, unknown>>(next: T, prev: T): Partial<T> {
	const out: Partial<T> = {};
