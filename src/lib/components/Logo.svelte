	...
	<g transform="translate(-101.76 -135.84)">
		<g transform="translate(-169.65 163.8)">
			<path
				...
				aria-hidden="true"
				class="scale-100 transition duration-500 hover:-translate-15 hover:scale-105 hover:brightness-125 {clickStylesLeft}"
			...
			<path
				...
				aria-hidden="true"
				class="scale-100 transition duration-500 hover:-translate-15 hover:scale-105 hover:brightness-125 {clickStylesRight}"
				transform="matrix(.13333 0 0 -.13333 0 5333.3)"
