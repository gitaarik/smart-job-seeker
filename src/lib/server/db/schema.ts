...
export const directus_comments = pgTable("directus_comments", {
	...
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`),
	date_updated: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`),
	user_created: uuid(),
	user_updated: uuid(),
}, (table) => [
	foreignKey({
...
export const directus_activity = pgTable("directus_activity", {
	...
	user: uuid(),
	timestamp: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const directus_notifications = pgTable("directus_notifications", {
	id: serial().primaryKey().notNull(),
	timestamp: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`),
...
export const directus_migrations = pgTable("directus_migrations", {
	...
	name: varchar({ length: 255 }).notNull(),
	timestamp: timestamp({ withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`),
});
...
export const directus_flows = pgTable("directus_flows", {
	...
	options: json(),
	operation: uuid(),
	date_created: timestamp({ withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`),
	user_created: uuid(),
}, (table) => [
	foreignKey({
			columns: [table.user_created],
...
export const job_matches = pgTable("job_matches", {
	...
	job_date_updated_when_matched: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
	date_updated: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
...
export const search_task_runs = pgTable("search_task_runs", {
	...
	started_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const profile_tokens = pgTable("profile_tokens", {
	...
	name: varchar({ length: 255 }),
	notes: text(),
	last_accessed_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
...
export const accounts = pgTable("accounts", {
	...
	accessToken: text(),
	refreshToken: text(),
	accessTokenExpiresAt: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
	refreshTokenExpiresAt: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
...
export const directus_sessions = pgTable("directus_sessions", {
	...
	user: uuid(),
	expires: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).notNull(),
...
export const scraper_agent_sessions = pgTable("scraper_agent_sessions", {
	...
	system_prompt: text(),
	error_message: text(),
	created_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	updated_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	finished_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
...
export const import_logs = pgTable("import_logs", {
	id: serial().primaryKey().notNull(),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const subscriptions = pgTable("subscriptions", {
	...
	current_period_start: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).notNull(),
	current_period_end: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).notNull(),
...
export const credit_transactions = pgTable("credit_transactions", {
	...
	description: text(),
	metadata: jsonb(),
	created_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).defaultNow().notNull(),
}, (table) => [
...
export const inbound_emails = pgTable("inbound_emails", {
	...
	received_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const user_feedback_subscribers = pgTable("user_feedback_subscribers", {
	...
	feedback_id: integer().notNull(),
	user_id: text().notNull(),
	subscribed_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
}, (table) => [
...
export const files = pgTable("files", {
	...
	created_on: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	modified_on: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
}, (table) => [
	foreignKey({
...
export type ApplicationActivityLog = typeof application_activity_log.$inferSelect;
...
export type WorkExperienceProjects = typeof work_experience_projects.$inferSelect;
export type WorkExperienceTechnologies = typeof work_experience_technologies.$inferSelect;
...
export type WorkExperienceProjectTechnologies = typeof work_experience_project_technologies.$inferSelect;
...
export type ProfileVersionExtensions = typeof profile_version_extensions.$inferSelect;
export type SideProjectAchievements = typeof side_project_achievements.$inferSelect;
...
export type ScraperAgentIterations = typeof scraper_agent_iterations.$inferSelect;
...
export type VerificationEmailAddresses = typeof verification_email_addresses.$inferSelect;
