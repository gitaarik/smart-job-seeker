...
export const application_activity_log_id_seq = pgSequence('application_activity_log_id_seq', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_activity_log_id_seq1 = pgSequence('application_activity_log_id_seq1', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_activity_log_id_seq2 = pgSequence('application_activity_log_id_seq2', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_activity_log_id_seq3 = pgSequence('application_activity_log_id_seq3', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_letters_id_seq = pgSequence('application_letters_id_seq', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_letters_id_seq1 = pgSequence('application_letters_id_seq1', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_letters_id_seq2 = pgSequence('application_letters_id_seq2', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_letters_id_seq3 = pgSequence('application_letters_id_seq3', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_questions_id_seq = pgSequence('application_questions_id_seq', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_questions_id_seq1 = pgSequence('application_questions_id_seq1', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_questions_id_seq2 = pgSequence('application_questions_id_seq2', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_questions_id_seq3 = pgSequence('application_questions_id_seq3', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const application_questions_id_seq4 = pgSequence('application_questions_id_seq4', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const applications_files_id_seq = pgSequence('applications_files_id_seq', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const applications_files_id_seq1 = pgSequence('applications_files_id_seq1', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const applications_files_id_seq2 = pgSequence('applications_files_id_seq2', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const applications_files_id_seq3 = pgSequence('applications_files_id_seq3', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const side_project_achievements_id_seq = pgSequence('side_project_achievements_id_seq', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const tech_skill_categories_id_seq = pgSequence('tech_skill_categories_id_seq', {
	startWith: '1',
	increment: '1',
	minValue: '1',
	maxValue: '2147483647',
...
export const ai_prompts = pgTable(
	'ai_prompts',
	{
		...
		sort: integer(),
		date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).default(
	...
	(table) => [
		...
		uniqueIndex('ai_prompts_name_unique').using('btree', table.name.asc().nullsLast())
	]
);

export const collected_data = pgTable(
	'collected_data',
	{
	...
	(table) => [
		index('collected_data_profile_updated_idx').on(table.profile_id, table.date_updated.desc()),
		foreignKey({
...
export const highlights = pgTable(
	...
	{
		id: integer()
			.default(sql`nextval('highlights_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
		sort: integer(),
...
export const match_config = pgTable(
	'match_config',
	{
		id: serial().primaryKey().notNull(),
		date_created: timestamp({ withTimezone: true, mode: 'date' }),
...
export const job_matches = pgTable(
	...
	(table) => [
		...
		index('job_matches_profile_score_idx').on(table.profile_id, table.score.desc()),
...
export const job_resources = pgTable(
	'job_resources',
	{
		id: serial().primaryKey().notNull(),
		sort: integer(),
...
export const search_task_runs = pgTable(
	'search_task_runs',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		index('search_task_runs_active_idx')
			.on(table.started_at)
			.where(sql`status IN ('stopping','queued','running','blocked')`),
 ...
 */
export const platform_profiles = pgTable(
	'platform_profiles',
	{
		id: serial().primaryKey().notNull(),
...
export const job_platforms = pgTable(
	'job_platforms',
	{
		id: serial().primaryKey().notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
...
export const job_platform_changes = pgTable(
...
export const search_task_run_items = pgTable(
...
export const jobs = pgTable(
	...
	(table) => [
		...
		index('jobs_source_url_idx').using('btree', table.source_url.asc().nullsLast()),
		foreignKey({
...
export const profile_tokens = pgTable(
	'profile_tokens',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		...
		uniqueIndex('profile_tokens_token_unique').using('btree', table.token.asc().nullsLast())
	]
);

export const project_stories = pgTable(
	'project_stories',
	{
		id: integer()
			.default(sql`nextval('project_stories_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		sort: integer(),
		date_created: timestamp({ withTimezone: true, mode: 'date' }),
...
export const profile_exports = pgTable(
	'profile_exports',
	{
		id: serial().primaryKey().notNull(),
		status: varchar({ length: 255 }).default('published').notNull(),
 ...
 */
export const search_form_probe_runs = pgTable(
 ...
 */
export const search_form_probe_logs = pgTable(
 ...
 */
export const search_form_probe_debug = pgTable(
...
// root.
export const scraper_log_steps = pgTable(
	'scraper_log_steps',
	{
		id: serial().primaryKey().notNull(),
		run_id: integer().notNull(),
	...
	(table) => [
		...
		index('scraper_log_steps_parent_idx').using('btree', table.parent_step_id.asc().nullsLast()),
		foreignKey({
			columns: [table.run_id],
			foreignColumns: [search_task_runs.id],
...
export const scraper_logs = pgTable(
	'scraper_logs',
	{
		id: serial().primaryKey().notNull(),
		run_id: integer().notNull(),
	...
	(table) => [
		...
		index('scraper_logs_step_id_idx').using('btree', table.step_id.asc().nullsLast()),
		foreignKey({
			columns: [table.run_id],
			foreignColumns: [search_task_runs.id],
...
export const work_experience_achievements = pgTable(
	...
	{
		id: integer()
			.default(sql`nextval('work_experience_achievements_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
		sort: integer(),
...
export const tech_skill_types = pgTable(
	'tech_skill_types',
	{
		id: serial().primaryKey().notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
	...
	(table) => [uniqueIndex('tech_skill_types_slug_key').using('btree', table.slug.asc().nullsLast())]
);
...
export const work_experience_projects = pgTable(
...
export const work_experience_technologies = pgTable(
	...
	{
		id: integer()
			.default(sql`nextval('work_experience_technologies_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
		sort: integer(),
...
export const tech_skill_categories = pgTable(
	'tech_skill_categories',
	{
		id: integer()
			.default(sql`nextval('tech_skill_categories_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
		sort: integer(),
...
export const tech_skills = pgTable(
	'tech_skills',
	{
		id: serial().primaryKey().notNull(),
		status: varchar({ length: 255 }).default('draft').notNull(),
...
export const cheat_sheets = pgTable(
	'cheat_sheets',
	{
		id: integer()
			.default(sql`nextval('cheat_sheets_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		sort: integer(),
		date_created: timestamp({ withTimezone: true, mode: 'date' }),
...
export const side_project_achievements = pgTable(
	...
	{
		id: integer()
			.default(sql`nextval('side_project_achievements_id_seq'::regclass)`)
			.primaryKey()
			.notNull(),
		description: varchar({ length: 255 }),
		side_project_id: integer().notNull(),
...
export const api_keys = pgTable(
	...
	(table) => [
		...
		index('idx_api_keys_user').using('btree', table.user_id.asc().nullsLast()),
		foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const search_tasks = pgTable(
	'search_tasks',
	{
		id: serial().primaryKey().notNull(),
		...
		// When the user explicitly paused this task via the list toggle. Null means
		// "never user-paused", which is what lets `auth-block` re-activate a task
		// by itself once a blocked login recovers; a set value means hands off,
		// because that promotion must never override a deliberate pause. Cleared
		// when the user re-activates.
	...
	(table) => [
		index('search_tasks_next_run_idx')
			.on(table.next_scheduled_run)
			.where(sql`is_active AND schedule_interval_hours IS NOT NULL`),
 ...
 */
export const ai_generations = pgTable(
	'ai_generations',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [uniqueIndex('ai_generations_entity_unique').on(table.entity_type, table.entity_id)]
);
 ...
 */
export const agent_message_proposals = pgTable(
...
export const scraper_agent_iterations = pgTable(
...
export const scraper_agent_sessions = pgTable(
	...
	(table) => [
		...
		index('scraper_agent_sessions_status_idx').using('btree', table.status.asc().nullsLast()),
		foreignKey({
			columns: [table.search_task_id],
			foreignColumns: [search_tasks.id],
...
export const import_logs = pgTable(
	'import_logs',
	{
		id: serial().primaryKey().notNull(),
		date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' })
	...
	(table) => [
		index('import_logs_date_created_idx').using('btree', table.date_created.asc().nullsLast()),
		index('import_logs_user_id_idx').using('btree', table.user_id.asc().nullsLast())
	]
);

export const job_statuses = pgTable(
	'job_statuses',
	{
		id: serial().primaryKey().notNull(),
...
export const application_letters = pgTable(
	'application_letters',
	{
		id: serial().primaryKey().notNull(),
		date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }),
...
export const application_questions = pgTable(
...
export const application_status_log = pgTable(
 ...
 */
export const application_records = pgTable(
	'application_records',
	{
		id: serial().primaryKey().notNull(),
		application_id: integer().notNull(),
		 ...
		 */
		contacts: jsonb().$type<Array<{ name: string; role: string | null }>>().default([]).notNull(),
		/**
...
export const letter_versions = pgTable(
	'letter_versions',
	{
		id: serial().primaryKey().notNull(),
		date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).defaultNow(),
...
export const question_versions = pgTable(
	'question_versions',
	{
		id: serial().primaryKey().notNull(),
		date_created: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).defaultNow(),
...
export const cheat_sheet_versions = pgTable(
...
export const job_match_history = pgTable(
	'job_match_history',
	{
		id: serial().primaryKey().notNull(),
		job_id: integer().notNull(),
...
export const job_importers = pgTable(
	'job_importers',
	{
		id: serial().primaryKey().notNull(),
...
export const user_feedback_files = pgTable(
	'user_feedback_files',
	{
		id: serial().primaryKey().notNull(),
...
export const user_feedback = pgTable(
	...
	(table) => [
		index('user_feedback_category_idx').using('btree', table.category.asc().nullsLast()),
		index('user_feedback_date_created_idx').using('btree', table.date_created.asc().nullsLast()),
		index('user_feedback_merged_into_idx').using('btree', table.merged_into_id.asc().nullsLast()),
		index('user_feedback_status_idx').using('btree', table.status.asc().nullsLast()),
		index('user_feedback_user_id_idx').using('btree', table.user_id.asc().nullsLast()),
		foreignKey({
...
export const billing_customers = pgTable(
	'billing_customers',
	{
		id: serial().primaryKey().notNull(),
...
export const subscriptions = pgTable(
	...
	(table) => [
		...
		index('subscriptions_user_id_idx').using('btree', table.user_id.asc().nullsLast()),
		foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const credit_purchases = pgTable(
	'credit_purchases',
	{
		id: serial().primaryKey().notNull(),
		// Nulled rather than deleted when the account is erased: a payment record
	...
	(table) => [
		index('credit_purchases_user_id_idx').using('btree', table.user_id.asc().nullsLast()),
		foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const usage_counters = pgTable(
	...
	(table) => [
		index('usage_counters_period_idx').using('btree', table.period.asc().nullsLast()),
		foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const credit_balances = pgTable(
	'credit_balances',
	{
		id: serial().primaryKey().notNull(),
		user_id: text().notNull(),
...
export const credit_transactions = pgTable(
	...
	(table) => [
		index('credit_transactions_operation_idx').using('btree', table.operation.asc().nullsLast()),
...
export const inbound_emails = pgTable(
	'inbound_emails',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		...
		index('idx_inbound_emails_handler').using('btree', table.handler.asc().nullsLast()),
		index('idx_inbound_emails_received').using('btree', table.received_at.asc().nullsLast()),
		index('idx_inbound_emails_run').using('btree', table.run_id.asc().nullsLast()),
		index('idx_inbound_emails_status').using('btree', table.status.asc().nullsLast()),
		foreignKey({
...
export const sent_emails = pgTable(
	'sent_emails',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		index('idx_sent_emails_type').using('btree', table.type.asc().nullsLast()),
		index('idx_sent_emails_status').using('btree', table.status.asc().nullsLast()),
		index('idx_sent_emails_sent_at').using('btree', table.sent_at.asc().nullsLast()),
		index('idx_sent_emails_user').using('btree', table.user_id.asc().nullsLast())
	]
);
...
export const contacts = pgTable(
	...
	(table) => [
		...
		index('idx_contacts_recipient').using('btree', table.recipient_id.asc().nullsLast()),
		foreignKey({
 ...
 */
export const credential_shares = pgTable(
	'credential_shares',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		...
		index('idx_credential_shares_shared_with').using('btree', table.shared_with.asc().nullsLast()),
		foreignKey({
...
export const device_shares = pgTable(
	'device_shares',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		...
		index('idx_device_shares_shared_with').using('btree', table.shared_with.asc().nullsLast()),
		foreignKey({
			columns: [table.shared_with],
			foreignColumns: [users.id],
...
export const demo_links = pgTable(
	'demo_links',
	{
		id: serial().primaryKey().notNull(),
		...
		expires_at: timestamp({ precision: 6, withTimezone: true, mode: 'date' }).notNull(),
	...
	(table) => [
		uniqueIndex('demo_links_token_unique').using('btree', table.token.asc().nullsLast()),
		index('idx_demo_links_created_by').using('btree', table.created_by.asc().nullsLast()),
		index('idx_demo_links_demo_user').using('btree', table.demo_user_id.asc().nullsLast()),
		foreignKey({
...
export const demo_link_devices = pgTable(
	'demo_link_devices',
	{
		id: serial().primaryKey().notNull(),
...
export const feedback_replies = pgTable(
	'feedback_replies',
	{
		id: serial().primaryKey().notNull(),
	...
	(table) => [
		index('feedback_replies_feedback_idx').using('btree', table.feedback_id.asc().nullsLast()),
		foreignKey({
...
export const user_feedback_subscribers = pgTable(
	...
	(table) => [
		...
		index('user_feedback_subscribers_user_idx').using('btree', table.user_id.asc().nullsLast()),
		foreignKey({
			columns: [table.feedback_id],
			foreignColumns: [user_feedback.id],
...
export const profile_document_projects = pgTable(
...
export const profile_document_files = pgTable(
...
export const project_embeddings = pgTable(
	'project_embeddings',
	{
		id: serial().primaryKey().notNull(),
		profile_id: integer().notNull(),
...
export const content_embeddings = pgTable(
	...
	(table) => [
		...
		uniqueIndex('content_embeddings_unit_key').on(table.unit_type, table.unit_id, table.sub_id),
