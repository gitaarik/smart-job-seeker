...
describe('createApplicationQuestionFollowup', () => {
	...
	describe('validation', () => {
		it('should return error if application question not found', async () => {
			...
			expect(result.message).toContain('Application question with ID 999 not found');
		...
		it('should return error if question has no ai_chats', async () => {
			...
			const result = await createApplicationQuestionFollowup(200, 'Expand the answer');
	...
	describe('successful followup creation', () => {
		it('should create followup and update question reference', async () => {
			...
			const result = await createApplicationQuestionFollowup(200, 'Add specific examples');

			expect(result.success).toBe(true);
			expect(result.message).toContain('Follow-up AI chat created successfully');
			expect(result.message).toContain('ID: 6');
			expect(result.message).toContain('Application question 200 has been updated');
	...
	describe('error handling', () => {
		...
		it('should handle database errors gracefully', async () => {
			...
			expect(result.success).toBe(false);
			expect(result.message).toContain('Error creating application question follow-up');
