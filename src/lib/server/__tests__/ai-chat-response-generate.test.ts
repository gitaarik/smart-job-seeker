...
describe("generateAiChatResponse", () => {
  ...
  it("should call Groq API with correct parameters", async () => {
    ...
    expect(groqInstance.chat.completions.create).toHaveBeenCalledWith({
  ...
  it("should handle Groq API error gracefully", async () => {
    ...
    groqInstance.chat.completions.create.mockRejectedValueOnce(apiError);
  ...
  it("should handle database update error", async () => {
    ...
    prismaClient.ai_chat.update.mockRejectedValueOnce(dbError);
  ...
  it("should use variable interpolation before sending to Groq", async () => {
    ...
    const callArgs = groqInstance.chat.completions.create.mock.calls[0][0];
  ...
  it("should process multiple responses correctly", async () => {
    ...
    expect(prismaClient.ai_chat.update).toHaveBeenCalledTimes(2);
  });
});
