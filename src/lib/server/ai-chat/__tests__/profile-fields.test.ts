...
describe("profile field lists (composed from CORE)", () => {
  it("STORY = the documented behavioural-story fields", () => {
    expect(set(STORY_PROFILE_FIELDS)).toEqual(set([
      "name", "title", "headline", "subtitle", "summary", "core_stack",
      "highlights", "work_experiences", "side_projects", "education",
      "tech_skill_categories", "project_stories",
    ]));
  });

  it("CHEATSHEET = the documented cheat-sheet fields", () => {
    expect(set(CHEATSHEET_PROFILE_FIELDS)).toEqual(set([
      "name", "title", "headline", "subtitle", "summary", "core_stack",
      "highlights", "work_experiences", "side_projects", "education",
  ...
  it("LETTER = the documented letter fields", () => {
    expect(set(LETTER_PROFILE_FIELDS)).toEqual(set([
      "name", "title", "headline", "subtitle", "summary", "location",
      "core_stack", "highlights", "work_experiences", "side_projects",
      "education", "tech_skill_categories", "languages",
    ]));
  });

  it("QUESTION = the documented question fields", () => {
    expect(set(QUESTION_PROFILE_FIELDS)).toEqual(set([
      "name", "title", "headline", "subtitle", "summary", "location",
      "core_stack", "highlights", "work_experiences", "side_projects",
      "education", "tech_skill_categories", "languages", "project_stories",
      "references",
    ]));
  });
