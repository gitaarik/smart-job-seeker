...
import { faGithub, faNodeJs, faPython } from '@fortawesome/free-brands-svg-icons';
...
export const resume = {
	basics: {
		...
		highlights: [
			{
				description: '<strong>18+ years</strong> of full stack development experience.',
				icon: faGem
			},
			...
			{
				description: 'Additional experience in <strong>DevOps & CI/CD.</strong>',
				icon: faServer
			},
	...
	workAccomplishment: {
		...
		description: `My most impressive accomplishment was transforming Chipta from an early-stage proof of concept to a platform handling tens of millions in transactions. I led the complete migration to Django + React and modern web technologies, guided the creation of the React Native mobile app, and established a quality testing suite. Over ${yearsAtChipta} years, I built this into a robust system processing thousands of orders per minute during peak events while growing and leading the development team.`,
		impact:
		...
		accomplishments: [
			{
				...
				description: `Led teams of 3-5 developers at innovative ticketing platform for over ${yearsAtChipta} years, scaling the platform from concept to processing thousands of orders per minute. Optimized platform performance by 30-60%, enabling the company to handle massive traffic spikes during high-demand events.`,
	...
	skills: [
...

		{
			...
			level: 'Proficient',
			icon: faCloud,
			keywords: ['Vercel', 'Linode', 'Amazon Web Services (AWS)']
		}
		// {
			...
			questions: [
				{
					...
					answer: {
						title: 'Introducing Team Management Structure at Chipta',
						situation: [
						...
						task: [
							'Introduce structured development methodologies',
						...
						action: [
							'Progressively introduced Scrum/Agile methodologies with team buy-in',
