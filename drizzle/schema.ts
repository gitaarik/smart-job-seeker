import { pgTable, varchar, timestamp, text, integer, unique, serial, json, index, uniqueIndex, foreignKey, uuid, date, boolean, jsonb, doublePrecision, type AnyPgColumn, numeric, bigint, pgSequence, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const Role = pgEnum("Role", ['USER', 'ADMIN', 'SUPER_ADMIN'])

export const ai_chats_id_seq = pgSequence("ai_chats_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const ai_chats_id_seq1 = pgSequence("ai_chats_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const ai_chats_id_seq2 = pgSequence("ai_chats_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const ai_chats_id_seq3 = pgSequence("ai_chats_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_activity_log_id_seq = pgSequence("application_activity_log_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_activity_log_id_seq1 = pgSequence("application_activity_log_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_activity_log_id_seq2 = pgSequence("application_activity_log_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_activity_log_id_seq3 = pgSequence("application_activity_log_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_letters_id_seq = pgSequence("application_letters_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_letters_id_seq1 = pgSequence("application_letters_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_letters_id_seq2 = pgSequence("application_letters_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_letters_id_seq3 = pgSequence("application_letters_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_questions_id_seq = pgSequence("application_questions_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_questions_id_seq1 = pgSequence("application_questions_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_questions_id_seq2 = pgSequence("application_questions_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_questions_id_seq3 = pgSequence("application_questions_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const application_questions_id_seq4 = pgSequence("application_questions_id_seq4", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_files_id_seq = pgSequence("applications_files_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_files_id_seq1 = pgSequence("applications_files_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_files_id_seq2 = pgSequence("applications_files_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_files_id_seq3 = pgSequence("applications_files_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_id_seq = pgSequence("applications_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_id_seq1 = pgSequence("applications_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_id_seq2 = pgSequence("applications_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const applications_id_seq3 = pgSequence("applications_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const cheat_sheets_id_seq = pgSequence("cheat_sheets_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const config_id_seq = pgSequence("config_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const config_id_seq1 = pgSequence("config_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const config_id_seq2 = pgSequence("config_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const config_id_seq3 = pgSequence("config_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const dev_methodologies_id_seq = pgSequence("dev_methodologies_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_activity_id_seq = pgSequence("directus_activity_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_activity_id_seq1 = pgSequence("directus_activity_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_activity_id_seq2 = pgSequence("directus_activity_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_activity_id_seq3 = pgSequence("directus_activity_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_notifications_id_seq = pgSequence("directus_notifications_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_notifications_id_seq1 = pgSequence("directus_notifications_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_notifications_id_seq2 = pgSequence("directus_notifications_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_notifications_id_seq3 = pgSequence("directus_notifications_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_presets_id_seq = pgSequence("directus_presets_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_presets_id_seq1 = pgSequence("directus_presets_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_presets_id_seq2 = pgSequence("directus_presets_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_presets_id_seq3 = pgSequence("directus_presets_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_revisions_id_seq = pgSequence("directus_revisions_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_revisions_id_seq1 = pgSequence("directus_revisions_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_revisions_id_seq2 = pgSequence("directus_revisions_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const directus_revisions_id_seq3 = pgSequence("directus_revisions_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const highlights_id_seq = pgSequence("highlights_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_matches_id_seq = pgSequence("job_matches_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_matches_id_seq1 = pgSequence("job_matches_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_matches_id_seq2 = pgSequence("job_matches_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_matches_id_seq3 = pgSequence("job_matches_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_resources_id_seq = pgSequence("job_resources_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_resources_id_seq1 = pgSequence("job_resources_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_resources_id_seq2 = pgSequence("job_resources_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const job_resources_id_seq3 = pgSequence("job_resources_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const jobs_id_seq = pgSequence("jobs_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const jobs_id_seq1 = pgSequence("jobs_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const jobs_id_seq2 = pgSequence("jobs_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const jobs_id_seq3 = pgSequence("jobs_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const languages_id_seq = pgSequence("languages_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_exports_id_seq = pgSequence("profile_exports_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_exports_id_seq1 = pgSequence("profile_exports_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_exports_id_seq2 = pgSequence("profile_exports_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_exports_id_seq3 = pgSequence("profile_exports_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_tokens_id_seq = pgSequence("profile_tokens_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_tokens_id_seq1 = pgSequence("profile_tokens_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_tokens_id_seq2 = pgSequence("profile_tokens_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const profile_tokens_id_seq3 = pgSequence("profile_tokens_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const project_stories_id_seq = pgSequence("project_stories_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const side_project_achievements_id_seq = pgSequence("side_project_achievements_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const soft_skills_id_seq = pgSequence("soft_skills_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const tech_skill_categories_id_seq = pgSequence("tech_skill_categories_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
...
export const ai_prompts = pgTable("ai_prompts", {
	...
	sort: integer(),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
	user_created: uuid(),
	date_updated: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	user_updated: uuid(),
	...
	uniqueIndex("ai_prompts_name_unique").using("btree", table.name.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const application_activity_log = pgTable("application_activity_log", {
	id: serial().primaryKey().notNull(),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	date: date(),
...
export const directus_comments = pgTable("directus_comments", {
	...
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
	date_updated: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
	user_created: uuid(),
	user_updated: uuid(),
}, (table) => [
	foreignKey({
...
export const directus_deployments = pgTable("directus_deployments", {
	...
	uniqueIndex("directus_deployments_provider_unique").using("btree", table.provider.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_created],
			foreignColumns: [directus_users.id],
...
export const directus_notifications = pgTable("directus_notifications", {
	id: serial().primaryKey().notNull(),
	timestamp: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
...
export const highlights = pgTable("highlights", {
	id: integer().default(sql`nextval('highlights_id_seq'::regclass)`).primaryKey().notNull(),
	status: varchar({ length: 255 }).default('draft').notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
...
export const directus_shares = pgTable("directus_shares", {
	...
	user_created: uuid(),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
	date_start: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	date_end: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
...
export const job_matches = pgTable("job_matches", {
	...
	job_date_updated_when_matched: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	...
	index("job_matches_profile_id_job_id_idx").using("btree", table.profile_id.asc().nullsLast().op("int4_ops"), table.job_id.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const search_task_runs = pgTable("search_task_runs", {
	...
	started_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	finished_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	jobs_found: integer(),
	error_message: text(),
...
export const languages = pgTable("languages", {
	id: integer().default(sql`nextval('languages_id_seq'::regclass)`).primaryKey().notNull(),
	status: varchar({ length: 255 }).default('draft').notNull(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
	name: varchar({ length: 255 }),
...
export const job_platforms = pgTable("job_platforms", {
	...
	key: varchar({ length: 255 }).default(sql`NULL`).notNull(),
...
export const search_task_run_items = pgTable("search_task_run_items", {
	...
	index("idx_search_task_run_items_run_id").using("btree", table.run_id.asc().nullsLast().op("int4_ops")),
	index("idx_search_task_run_items_run_status").using("btree", table.run_id.asc().nullsLast().op("int4_ops"), table.status.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.job_id],
			foreignColumns: [jobs.id],
...
export const jobs = pgTable("jobs", {
	...
	import_error: text(),
	last_scraped: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	...
	soft_skills: jsonb(),
	rescrape_status: varchar({ length: 50 }).default(sql`NULL`),
	rescrape_message: text(),
	rescrape_live_url: text(),
	region: varchar({ length: 50 }),
	salary_duration_weeks: doublePrecision(),
}, (table) => [
	index("idx_jobs_uniqueness").using("btree", table.title.asc().nullsLast().op("date_ops"), table.job_poster.asc().nullsLast().op("date_ops"), table.date_posted.asc().nullsLast().op("text_ops")),
	index("jobs_source_url_idx").using("btree", table.source_url.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const profile_tokens = pgTable("profile_tokens", {
	...
	name: varchar({ length: 255 }),
	notes: text(),
	last_accessed_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	...
	uniqueIndex("profile_tokens_token_hash_unique").using("btree", table.token_hash.asc().nullsLast().op("text_ops")),
	uniqueIndex("profile_tokens_token_unique").using("btree", table.token.asc().nullsLast().op("text_ops")),
]);

export const project_stories = pgTable("project_stories", {
	id: integer().default(sql`nextval('project_stories_id_seq'::regclass)`).primaryKey().notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
	title: varchar({ length: 255 }),
...
export const references = pgTable("references", {
	...
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
	author: varchar({ length: 255 }).default(sql`NULL`).notNull(),
...
export const scraper_logs = pgTable("scraper_logs", {
	...
	index("scraper_logs_run_id_timestamp_idx").using("btree", table.run_id.asc().nullsLast().op("int4_ops"), table.timestamp.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.run_id],
			foreignColumns: [search_task_runs.id],
...
export const salary_expectations = pgTable("salary_expectations", {
	...
	company_type: varchar({ length: 255 }).default(sql`NULL`).notNull(),
	employment_type: varchar({ length: 255 }).default(sql`NULL`).notNull(),
	work_arrangement: varchar({ length: 255 }).default(sql`NULL`).notNull(),
	region: varchar({ length: 255 }).default(sql`NULL`).notNull(),
	hourly_rate: integer(),
...
export const work_experience_achievements = pgTable("work_experience_achievements", {
	id: integer().default(sql`nextval('work_experience_achievements_id_seq'::regclass)`).primaryKey().notNull(),
	status: varchar({ length: 255 }).default('draft').notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
...
export const tech_skill_types = pgTable("tech_skill_types", {
	...
	uniqueIndex("tech_skill_types_slug_key").using("btree", table.slug.asc().nullsLast().op("text_ops")),
]);
...
export const sessions = pgTable("sessions", {
	...
	userId: text().notNull(),
	token: varchar({ length: 255 }).notNull(),
	expiresAt: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).notNull(),
...
export const work_experience_technologies = pgTable("work_experience_technologies", {
	id: integer().default(sql`nextval('work_experience_technologies_id_seq'::regclass)`).primaryKey().notNull(),
	status: varchar({ length: 255 }).default('draft').notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
...
export const tech_skill_categories = pgTable("tech_skill_categories", {
	id: integer().default(sql`nextval('tech_skill_categories_id_seq'::regclass)`).primaryKey().notNull(),
	status: varchar({ length: 255 }).default('draft').notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
...
export const work_experience_project_technologies = pgTable("work_experience_project_technologies", {
	id: serial().primaryKey().notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
...
export const accounts = pgTable("accounts", {
	...
	accessToken: text(),
	refreshToken: text(),
	accessTokenExpiresAt: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	refreshTokenExpiresAt: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
...
export const cheat_sheets = pgTable("cheat_sheets", {
	id: integer().default(sql`nextval('cheat_sheets_id_seq'::regclass)`).primaryKey().notNull(),
	sort: integer(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
	title: varchar({ length: 255 }),
...
export const directus_deployment_projects = pgTable("directus_deployment_projects", {
	...
	uniqueIndex("directus_deployment_projects_deployment_external_id_unique").using("btree", table.deployment.asc().nullsLast().op("text_ops"), table.external_id.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const directus_sessions = pgTable("directus_sessions", {
	...
	user: uuid(),
	expires: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).notNull(),
...
export const profile_version_extensions = pgTable("profile_version_extensions", {
	id: serial().primaryKey().notNull(),
	extender_id: integer(),
	extended_id: integer(),
}, (table) => [
...
export const side_project_achievements = pgTable("side_project_achievements", {
	id: integer().default(sql`nextval('side_project_achievements_id_seq'::regclass)`).primaryKey().notNull(),
	description: varchar({ length: 255 }),
	side_project_id: integer().notNull(),
	date_created: timestamp({ withTimezone: true, mode: 'string' }),
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
...
export const api_keys = pgTable("api_keys", {
	...
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`),
	expires_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	last_used: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	...
	index("idx_api_keys_hash").using("btree", table.key_hash.asc().nullsLast().op("text_ops")),
	index("idx_api_keys_profile").using("btree", table.profile_id.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.profile_id],
			foreignColumns: [profiles.id],
...
export const search_tasks = pgTable("search_tasks", {
	...
	date_updated: timestamp({ withTimezone: true, mode: 'string' }),
	profile_id: integer().notNull(),
	last_run: timestamp({ withTimezone: true, mode: 'string' }),
	search_url: text(),
	platform_id: integer(),
	navigation_type: varchar({ length: 255 }).default(sql`NULL`),
	stripped_html: text(),
	last_run_jobs_found: integer(),
	live_url: varchar({ length: 500 }).default(sql`NULL`),
	is_active: boolean().default(true).notNull(),
	status_message: varchar({ length: 255 }).default(sql`NULL`),
	platform_profile_id: integer(),
	max_jobs: integer(),
	browser_provider: varchar({ length: 20 }).default(sql`NULL`),
	search_term: varchar({ length: 500 }).default(sql`NULL`),
	...
	next_scheduled_run: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	tunnel_api_key: integer(),
	login_mode: varchar({ length: 10 }).default('auto').notNull(),
}, (table) => [
	index("idx_search_tasks_platform_profile").using("btree", table.platform_profile_id.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.profile_id],
			foreignColumns: [profiles.id],
...
export const scraper_agent_iterations = pgTable("scraper_agent_iterations", {
	...
	index("scraper_agent_iterations_session_id_iteration_idx").using("btree", table.session_id.asc().nullsLast().op("int4_ops"), table.iteration.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const scraper_agent_sessions = pgTable("scraper_agent_sessions", {
	...
	index("scraper_agent_sessions_search_task_id_idx").using("btree", table.search_task_id.asc().nullsLast().op("int4_ops")),
	index("scraper_agent_sessions_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.search_task_id],
			foreignColumns: [search_tasks.id],
...
export const import_logs = pgTable("import_logs", {
	id: serial().primaryKey().notNull(),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	...
	index("import_logs_date_created_idx").using("btree", table.date_created.asc().nullsLast().op("timestamptz_ops")),
	index("import_logs_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
]);
...
export const job_statuses = pgTable("job_statuses", {
	...
	uniqueIndex("job_statuses_profile_job_key").using("btree", table.profile.asc().nullsLast().op("int4_ops"), table.job.asc().nullsLast().op("int4_ops")),
	index("job_statuses_profile_status_idx").using("btree", table.profile.asc().nullsLast().op("int4_ops"), table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.job],
			foreignColumns: [jobs.id],
...
export const profiles = pgTable("profiles", {
	...
	phone_number: varchar({ length: 255 }).default(sql`NULL`),
	email_address: varchar({ length: 255 }).default(sql`NULL`),
	personal_website: varchar({ length: 255 }),
	subtitle: varchar({ length: 255 }).default(sql`NULL`),
	core_stack: varchar({ length: 255 }).default(sql`NULL`),
...
export const letter_versions = pgTable("letter_versions", {
	id: serial().primaryKey().notNull(),
	date_created: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).defaultNow(),
...
export const job_match_history = pgTable("job_match_history", {
	...
	index("job_match_history_date_idx").using("btree", table.job.asc().nullsLast().op("int4_ops"), table.date_created.desc().nullsFirst().op("int4_ops")),
	index("job_match_history_profile_job_idx").using("btree", table.profile.asc().nullsLast().op("int4_ops"), table.job.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.job],
			foreignColumns: [jobs.id],
...
export const job_importers = pgTable("job_importers", {
	...
	uniqueIndex("job_importers_job_profile_unique").using("btree", table.job.asc().nullsLast().op("int4_ops"), table.profile.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.job],
			foreignColumns: [jobs.id],
...
export const user_feedback_files = pgTable("user_feedback_files", {
	...
	index("user_feedback_files_feedback_idx").using("btree", table.user_feedback_id.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const user_feedback = pgTable("user_feedback", {
	...
	index("user_feedback_category_idx").using("btree", table.category.asc().nullsLast().op("text_ops")),
	index("user_feedback_date_created_idx").using("btree", table.date_created.asc().nullsLast().op("timestamptz_ops")),
	index("user_feedback_merged_into_idx").using("btree", table.merged_into_id.asc().nullsLast().op("int4_ops")),
	index("user_feedback_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
	index("user_feedback_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const subscriptions = pgTable("subscriptions", {
	...
	current_period_start: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).notNull(),
	current_period_end: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).notNull(),
	...
	index("subscriptions_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const credit_purchases = pgTable("credit_purchases", {
	...
	index("credit_purchases_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const usage_counters = pgTable("usage_counters", {
	...
	index("usage_counters_period_idx").using("btree", table.period.asc().nullsLast().op("text_ops")),
	index("usage_counters_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const verification_email_addresses = pgTable("verification_email_addresses", {
	id: serial().primaryKey().notNull(),
	profile_id: integer().notNull(),
	...
	index("idx_verification_email_addresses_token").using("btree", table.email_token.asc().nullsLast().op("text_ops")),
	uniqueIndex("verification_email_addresses_email_token_key").using("btree", table.email_token.asc().nullsLast().op("text_ops")),
	uniqueIndex("verification_email_addresses_profile_id_key").using("btree", table.profile_id.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.profile_id],
			foreignColumns: [profiles.id],
...
export const credit_balances = pgTable("credit_balances", {
	...
	index("credit_balances_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const credit_transactions = pgTable("credit_transactions", {
	...
	index("credit_transactions_operation_idx").using("btree", table.operation.asc().nullsLast().op("text_ops")),
	index("credit_transactions_user_id_created_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops"), table.created_at.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.user_id],
			foreignColumns: [users.id],
...
export const certificates = pgTable("certificates", {
	...
	index("idx_certificates_profile").using("btree", table.profile.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.profile],
			foreignColumns: [profiles.id],
...
export const inbound_emails = pgTable("inbound_emails", {
	...
	received_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	applied_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }),
	recipient: varchar({ length: 255 }).notNull(),
	handler: varchar({ length: 50 }),
}, (table) => [
	index("idx_inbound_emails_address").using("btree", table.verification_address_id.asc().nullsLast().op("int4_ops")),
	index("idx_inbound_emails_handler").using("btree", table.handler.asc().nullsLast().op("text_ops")),
	index("idx_inbound_emails_received").using("btree", table.received_at.asc().nullsLast().op("timestamptz_ops")),
	index("idx_inbound_emails_run").using("btree", table.run_id.asc().nullsLast().op("int4_ops")),
	index("idx_inbound_emails_status").using("btree", table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const contacts = pgTable("contacts", {
	...
	uniqueIndex("contacts_pair_unique").using("btree", table.requester_id.asc().nullsLast().op("text_ops"), table.recipient_id.asc().nullsLast().op("text_ops")),
	index("idx_contacts_recipient").using("btree", table.recipient_id.asc().nullsLast().op("text_ops")),
	index("idx_contacts_requester").using("btree", table.requester_id.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const device_shares = pgTable("device_shares", {
	...
	uniqueIndex("device_shares_key_user_unique").using("btree", table.api_key_id.asc().nullsLast().op("text_ops"), table.shared_with.asc().nullsLast().op("int4_ops")),
	index("idx_device_shares_api_key").using("btree", table.api_key_id.asc().nullsLast().op("int4_ops")),
	index("idx_device_shares_shared_with").using("btree", table.shared_with.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const feedback_replies = pgTable("feedback_replies", {
	...
	index("feedback_replies_feedback_idx").using("btree", table.feedback_id.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const user_feedback_subscribers = pgTable("user_feedback_subscribers", {
	...
	feedback_id: integer().notNull(),
	user_id: text().notNull(),
	subscribed_at: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
}, (table) => [
	uniqueIndex("user_feedback_subscribers_unique").using("btree", table.feedback_id.asc().nullsLast().op("int4_ops"), table.user_id.asc().nullsLast().op("int4_ops")),
	index("user_feedback_subscribers_user_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.feedback_id],
			foreignColumns: [user_feedback.id],
...
export const notifications = pgTable("notifications", {
	...
	index("notifications_user_id_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops")),
	index("notifications_user_unread_idx").using("btree", table.user_id.asc().nullsLast().op("text_ops"), table.read_at.asc().nullsLast().op("text_ops")),
]);
...
export const files = pgTable("files", {
	...
	created_on: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	modified_on: timestamp({ precision: 6, withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
}, (table) => [
	foreignKey({
